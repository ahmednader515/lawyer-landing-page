...
export default function Home() {
  return (
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text)] font-sans flex flex-col items-stretch transition-colors duration-300">
      {/* Navbar */}
      <nav className="w-full flex items-center md:px-12 py-0.5 pb-5 z-50 absolute top-0 left-0 bg-gray-900">
        {/* Contact info vertically centered */}
        <div className="flex flex-row items-center gap-1 md:gap-6 text-[10px] md:text-sm text-gray-100 w-full justify-end h-full pt-5 pl-2">
          <span className="flex items-start gap-1 self-start">
            <p className="text-gray-100 text-[9.5px] md:text-sm">مكتب ٠٣/٤٨٥٦٠٩٥</p>
            <span>-</span>
        ...
        <div className="absolute right-2 md:right-12 top-1/2 md:top-full -translate-y-1/2 z-50 pointer-events-none pt-10">
          <div className="bg-gray-900 rounded-lg shadow-lg flex items-center justify-center p-[6px] md:p-[10px]">
      ...
      <section className="hero-bg flex flex-col md:flex-row items-center justify-center py-24 px-4 relative overflow-hidden shadow-lg text-center md:text-left gap-y-4 md:gap-x-8 bg-[var(--bg)] dark:bg-[var(--bg)] transition-colors duration-300 pt-28 md:pt-32">
        ...
        {/* Text Content */}
        <div className="flex-1 flex flex-col items-end md:items-end justify-center z-20 pl-0 md:pl-12 text-right md:text-right mr-1 md:mr-16">
          <h1 className="alex-brush text-2xl md:text-4xl mb-4 text-yellow-400 drop-shadow z-20 w-full text-right mb-5">أ. محمد السيد ابو سريع</h1>
          ...
          <p className="text-md md:text-2xl mb-8 text-gray-200 leading-relaxed z-20 w-full text-right">خبرة واسعة في تقديم الاستشارات القانونية والتمثيل أمام المحاكم في مختلف القضايا المدنية والتجارية والجنائية.</p>
          <a href="#contact" className="group bg-transparent border-2 border-[var(--accent)] text-[var(--accent)] px-10 py-4 rounded-lg text-md md:text-xl font-bold shadow hover:bg-[var(--accent)] hover:text-white transition z-20 flex items-center justify-center gap-2 md:justify-start text-right self-start">
      ...
      <section className="py-12 px-4 md:px-24 bg-[var(--bg)] dark:bg-[var(--bg)] flex flex-col items-center text-center gap-y-4 transition-colors duration-300" id="about">
        <h3 className="text-3xl font-bold mb-4 text-yellow-400">من نحن</h3>
        <div className="flex flex-col md:flex-row gap-10 w-full justify-center items-center md:items-start">
          ...
          <div className="bg-gray-900 rounded-2xl shadow-lg p-8 flex flex-col items-center max-w-2xl w-full md:w-1/2 border-t-4 border-[var(--accent)] mb-8 md:mb-0">
            ...
            <h3 className="text-2xl font-bold text-yellow-400 mb-2">الأستاذ محمد السيد ابو سريع</h3>
          ...
          <div className="flex-1 flex flex-col items-center text-center md:items-start md:text-right">
            ...
            <div className="mb-8 flex justify-center">
              <div className="bg-gray-800 rounded-2xl shadow-lg p-6 border-t-4 border-[var(--accent)] w-full max-w-[34rem] md:max-w-[34rem] flex flex-col items-center text-center md:w-[34rem]">
                <span className="text-2xl font-bold text-yellow-400 mb-2">الأستاذ محمد السيد ابو سريع</span>
                <span className="text-base text-gray-200 mb-1">ماجستير في القانون الجنائي</span>
                <span className="text-base text-gray-200 mb-1">دراسات عليا في القانون العام</span>
                <span className="text-base text-gray-200 mb-1">عضو اتحاد المحامين العرب</span>
                <span className="text-base text-gray-200">وعضو لجنة الحريات بنقابة المحامين</span>
              </div>
            </div>
            {/* Team Members */}
            <div className="mt-6">
              <h4 className="text-xl font-semibold mb-6 text-yellow-300">فريق عمل المكتب</h4>
              <div className="flex flex-col md:flex-row gap-8 justify-center items-center w-full">
                {/* Card 1 */}
                <div className="bg-gray-800 rounded-2xl shadow-lg p-6 flex flex-col items-center border-t-4 border-[var(--accent)] w-64">
                  <div className="p-2 border-2 border-[var(--accent)] rounded-tr-[60px] rounded-bl-[60px] shadow-md mb-4 w-32 h-32 flex items-center justify-center overflow-hidden">
                    ...
                    <img src="/lawyer-2.jpg" alt="عمر عزت عبد الله" className="object-cover w-28 h-28 rounded-tr-[50px] rounded-bl-[50px]" />
                  </div>
                  <span className="text-lg font-semibold text-gray-100">الأستاذ عمر عزت عبد الله</span>
                </div>
                {/* Card 2 */}
                <div className="bg-gray-800 rounded-2xl shadow-lg p-6 flex flex-col items-center border-t-4 border-[var(--accent)] w-64">
                  <div className="p-2 border-2 border-[var(--accent)] rounded-tr-[60px] rounded-bl-[60px] shadow-md mb-4 w-32 h-32 flex items-center justify-center overflow-hidden">
                    {/* Replace src with actual image later */}
                    <img src="/lawyer-1.jpg" alt="كريم يوسف التركي" className="object-cover w-28 h-28 rounded-tr-[50px] rounded-bl-[50px]" />
                  </div>
                  <span className="text-lg font-semibold text-gray-100">الأستاذ كريم يوسف التركي</span>
                </div>
              </div>
            </div>
          </div>
      ...
      {/* Divider */}
      <div className="w-16 h-1 bg-gray-700 mx-auto my-4 rounded-full" />

      {/* Practice Areas */}
      <section className="py-12 px-4 md:px-24 bg-gray-900 flex flex-col items-center text-center gap-y-8 transition-colors duration-300" id="services">
        <h3 className="text-3xl font-bold mb-8 text-yellow-400">مجالات الممارسة</h3>
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 w-full justify-items-center">
          <div className="bg-gray-800 rounded-2xl shadow-lg p-8 flex flex-col items-center h-full border-t-4 border-[var(--accent)] hover:scale-105 transition-transform">
            <FaGavel className="text-[var(--accent)] text-3xl mb-3" />
            <h4 className="text-xl font-semibold mb-2 text-yellow-200">القضايا الجنائية</h4>
            <p className="text-gray-300">تقديم الدعم والتمثيل القانوني امام كافة المحاكم الجنائية باختلاف درجاتها والمحاكم الاقتصادية والدفاع عن حقوق الموكلين حتى الوصول لحكم البراءة</p>
          </div>
          <div className="bg-gray-800 rounded-2xl shadow-lg p-8 flex flex-col items-center h-full border-t-4 border-[var(--accent)] hover:scale-105 transition-transform">
            <FaUsers className="text-[var(--accent)] text-3xl mb-3" />
            <h4 className="text-xl font-semibold mb-2 text-yellow-200">القضايا المدنية</h4>
            <p className="text-gray-300">تقديم الدعم والتمثيل القانوني امام المحاكم المدنية ومحاكم الطعن والدفاع عن حقوق الموكلين وحماية حقوقهم حتى صدور الحكم</p>
          </div>
          <div className="bg-gray-800 rounded-2xl shadow-lg p-8 flex flex-col items-center h-full border-t-4 border-[var(--accent)] hover:scale-105 transition-transform">
            <FaBalanceScale className="text-[var(--accent)] text-3xl mb-3" />
            <h4 className="text-xl font-semibold mb-2 text-yellow-200">القضايا التجارية</h4>
            <p className="text-gray-300">تقديم الاستشارات القانونية والتمثيل أمام المحاكم في النزاعات التجارية، وصياغة ومراجعة العقود بين الشركات، وتسوية الخلافات بين الشركاء أو الأطراف التجارية لضمان الحقوق وتقليل المخاطر القانونية.</p>
          </div>
          <div className="col-span-full flex flex-col md:flex-row justify-center gap-8 items-center">
            <div className="bg-gray-800 rounded-2xl shadow-lg p-8 flex flex-col items-center h-full border-t-4 border-[var(--accent)] hover:scale-105 transition-transform">
              <FaBalanceScale className="text-[var(--accent)] text-3xl mb-3" />
              <h4 className="text-xl font-semibold mb-2 text-yellow-200">قضايا الأحوال الشخصية</h4>
              <p className="text-gray-300">تقديم الدعم القانوني والتمثيل أمام محاكم الأسرة في قضايا الطلاق، الخُلع، النفقة، الحضانة، الرؤية، والميراث، مع الحرص على تحقيق أفضل النتائج بما يحفظ حقوق الموكل وكرامته.</p>
            </div>
            <div className="bg-gray-800 rounded-2xl shadow-lg p-8 flex flex-col items-center h-full border-t-4 border-[var(--accent)] hover:scale-105 transition-transform">
              <FaBalanceScale className="text-[var(--accent)] text-3xl mb-3" />
              <h4 className="text-xl font-semibold mb-2 text-yellow-200">صياغة العقود</h4>
              <p className="text-gray-300">صياغة كافة أنواع العقود صياغة قانونية منضبطة تحفظ حقوق الموكلين وتضمن نجاح تعاقداتهم</p>
            </div>
          </div>
        </div>
      </section>
      ...
      {/* Contact Section */}
      <section className="py-12 px-4 md:px-24 bg-[var(--bg)] flex flex-col items-center text-center gap-y-4 transition-colors duration-300" id="contact">
        <h3 className="text-3xl font-bold mb-4 text-yellow-400">تواصل معنا</h3>
        <p className="mb-4 text-lg text-gray-200">للاستفسار أو حجز موعد، يرجى التواصل عبر:</p>
        <div className="w-full flex flex-col md:flex-row justify-center items-start gap-8 mt-8">
          ...
          <form
            ...
            className="w-full md:w-1/2 max-w-lg mx-auto bg-gray-800 rounded-2xl shadow-lg p-6 mb-8 flex flex-col gap-4 border-t-4 border-[var(--accent)]"
          >
            <h4 className="text-xl font-bold mb-2 text-yellow-400">أرسل رسالة مباشرة</h4>
            <input
              type="text"
              name="name"
              required
              placeholder="الاسم الكامل"
              className="p-3 rounded-lg border border-gray-700 focus:outline-none focus:ring-2 focus:ring-[var(--accent)] bg-gray-900 text-right"
            />
            <input
              type="email"
              name="email"
          ...
          <div className="w-full md:w-1/2 flex flex-col justify-start items-center mt-0">
            <h1 className="text-2xl font-bold mb-4 text-yellow-400">موقع المكتب على الخريطة</h1>
            <iframe
            ...
            <ul className="mt-6 text-lg space-y-2 flex flex-col items-center w-full">
              <li className="flex flex-row-reverse items-center gap-2">
                ...
                <a href="tel:01024920913" className="text-yellow-300 hover:underline">٠١٠٢٤٩٢٠٩١٣</a>
                <span>-</span>
                <a href="tel:01285815568" className="text-yellow-300 hover:underline">٠١٢٨٥٨١٥٥٦٨</a>
              </li>
              <li className="flex flex-row-reverse items-center gap-2">
                ...
                <a href="mailto:MuhammadAbusree.lawfirm@gmail.com" className="text-yellow-300 hover:underline">MuhammadAbusree.lawfirm@gmail.com</a>
              </li>
              <li className="flex flex-row-reverse items-center gap-2">
                ...
                <span className="text-yellow-300">١٣ شارع الشهداء - محطة الرمل - الاسكندرية</span>
              </li>
              <li>
                          {/* Social Media Icons */}
      ...
      {/* Footer */}
      <footer className="mt-auto py-6 text-center text-gray-400 text-sm bg-gray-900 transition-colors duration-300">
